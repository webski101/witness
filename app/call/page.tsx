...
export default function CallPage() {
  return (
    <main className="mx-auto max-w-[1200px] px-4 py-12 sm:px-6 lg:px-10">
      ...
      <Card className="mt-12"><CardHeader><RadioTower /><CardTitle>POST /api/v1/trial</CardTitle><CardDescription>Content-Type: application/json</CardDescription></CardHeader><CardContent><pre className="overflow-x-auto border bg-muted/45 p-5 font-mono text-xs leading-relaxed">{requestBody}</pre></CardContent></Card>
